...
<html>
<body>
<h1>Welcome Muniprasad to Our Orgnaigestion</h1>
</body>
...
<body>
	<h2>Hello World!</h2>
		<d2>Hello World!</h2><
<p style="color:blue;"> Hello prasad  </p>
</body>
</html>
...
<body>
    <div class="background-counter d-flex flex-column justify-content-center">
        <p class="paragraph Text-center">Enter your Id</p>
        <input type="text" class="input" id="searchingen" />
        <p class="paragraph1 text">Enter your Password</p>
        <input type="password" class="input" />
        <div>
            <button class="mt-4 button" onclick="button()"> Search </button>
        </div>
        <p class="text" id="textalone"></p>
